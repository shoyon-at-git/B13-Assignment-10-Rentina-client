...
export default async function MyPropertiesPage() {
    ...
    const response = await fetch(`${serverUrl}/api/owner-properties/${session.user.id}`, {
        cache: "no-store",
    });
    ...
    if (!response.ok) {
        return (
            <div className="p-6">
                <h2 className="text-xl font-semibold">Failed to load properties</h2>
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-500">Total Properties: {properties.length}</p>
            </div>
            ...
            {properties.length === 0 ? (
                <div className="rounded-lg border p-10 text-center">
                    ...
                    <p className="mt-2 text-gray-500">Add your first property.</p>
                </div>
            ) : (
                /* =========================
                   Property Cards
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {properties.map((property) => (
                        <div key={property._id} className="overflow-hidden rounded-xl border bg-white shadow-sm">
                            {/* =========================
                                Image
                            ========================= */}
                            ...
                            <div className="space-y-2 p-4">
                                ...
                                <p className="font-semibold text-green-600">৳ {property.rent}/month</p>
